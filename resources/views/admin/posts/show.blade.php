                        ...
                        @if($comment->parent_id == NULL)
                            ...
                            @foreach($comment->children as $child)
                                <div class="comment children">
                                    <div class="author-image">
                                        <span style="background-image: url({{ Storage::url('users/'.$child->users->image) }});"></span>
                                    </div>
                                    <div class="content">
                                        <div class="author-name">
                                            <strong>{{ $child->users->name }}</strong>
                                            <span class="right">{{ $child->created_at->diffForHumans() }}</span>
                                        </div>
                                        <div class="author-comment">
                                            {{ $child->body }}
                                        </div>
