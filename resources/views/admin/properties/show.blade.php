                    ...
                    @foreach($property->comments as $comment)
                        ...
                        @if($comment->parent_id == NULL)
                            <div class="comment">
                                <div class="author-image">
                                    <span style="background-image: url('{{ Storage::url('users/'.(optional($comment->user)->image ?? 'default.png')) }}');"></span>
                                </div>
                                <div class="content">
                        ...
                        @foreach($comment->children as $reply)
                            <div class="comment children">
                                <div class="author-image">
                                    <span style="background-image: url('{{ Storage::url('users/'.(optional($reply->user)->image ?? 'default.png')) }}');"></span>
                                </div>
                                <div class="content">
                                    <div class="author-name">
                                        <strong>{{ optional($reply->user)->name ?? 'Unknown User' }}</strong>
                                        <span class="right">{{ $reply->created_at->diffForHumans() }}</span>
                                    </div>
                                    <div class="author-comment">
                                        {{ $reply->body }}
                                    </div>
