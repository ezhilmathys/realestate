<footer class="page-footer blue-grey darken-3">
            ...
            <div class="col m6 s12">
                ...
                <ul class="collection border0">
                    ...
                    <li class="collection-item transparent clearfix p-0 border0">
                        ...
                        @else
                            <span class="card-image-bg m-r-10" style="background-image:url({{ asset('images/placeholder.png') }});width:60px;height:45px;float:left;"></span>
                        @endif
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            @else
                © {{ date('Y') }} Real Estate Website PHP Laravel - Developed By InReality
            @endif
