                            ...
                            @foreach($property->comments as $comment)
                                ...
                                @foreach($comment->children as $commentchildren)
                                    <div class="comment children">
                                        ...
                                        <div class="content">
                                            <div class="author-name">
                                                <strong>{{ $commentchildren->user?->name ?? 'Unknown User' }}</strong>
...
@section('scripts')
    ...
    <script>
        ...
        var galleryNotEmpty = <?php echo json_encode($property->gallery->isNotEmpty()); ?>;
        if (galleryNotEmpty) {
            jssor_1_slider_init();
        }
    ...
    <script>
        function initMap() {
            var propLatLng = {
                lat: <?php echo json_encode((float) $property->location_latitude); ?>,
                lng: <?php echo json_encode((float) $property->location_longitude); ?>
            };
