...
class DashboardController extends Controller
{
    ...
    {   
        // Show only the authenticated user's comments and paginate for view->links()
    ...
    public function profileUpdate(Request $request)
    {
        ...
        $user = Auth::user();
        if (!$user) {
            Toastr::error('message', 'User not authenticated.');
        ...
        if(isset($image)){
            ...
            $userimage = Image::make($image)->encode($format, 90);
